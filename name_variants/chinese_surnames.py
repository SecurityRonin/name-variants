...
# Maps romanization variant (lowercase) -> romanization system/dialect.
# Covers the top ~30 Chinese surnames' variants.
# Systems: mandarin_pinyin, cantonese, hokkien, hakka, teochew, wade_giles,
#          traditional, simplified
CHINESE_ROMANIZATION_DIALECTS: dict[str, str] = {
    # 王 (Wáng)
